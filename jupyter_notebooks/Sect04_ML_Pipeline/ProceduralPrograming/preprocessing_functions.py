...
def elapsed_years(df, var, ref_var='YrSold'):
    """
    Capture difference between a year variable
    and a reference variable (year in which the 
    house was sold by default)
    """    
...
def encode_categorical(df, var, mappings):
    """Replace strings by numbers using mappings dictionary"""
